 ...
 * ADD CORS TO BACKEND
 *
 * Allows your React dev server (localhost:5173 Vite or :3001 CRA)
 * to call the backend on localhost:3000.
 *
 * Run from backend root:
 *   node src/scripts/add-cors.js
...
console.log('\n══════════════════════════════════════════');
console.log('  ADD CORS — backend → React frontend');
console.log('══════════════════════════════════════════\n');
...
console.log('\n══════════════════════════════════════════');
console.log('  DONE. Restart backend: npm run dev');
console.log('══════════════════════════════════════════\n');